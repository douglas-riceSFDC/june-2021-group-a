...
import rentTitle from "@salesforce/apex/TitleAuraService.rentTitle";
...
const FIELDS = [
  ...
  GENRE_FIELD,
  LANGUAGE_FIELD,
  NOTABLE_ACTORS_FIELD,
  PLOT_DESCRIPTION_FIELD,
  POSTER_FIELD,
  RELEASE_DATE_FIELD,
  RUNTIME_FIELD,
  WRITER_FIELD,
...
export default class TitleDetails extends LightningElement {
  ...
  get name() {
    return this.title.data ? getFieldValue(this.title.data, NAME_FIELD) : "";
  }
  get director() {
    return this.title.data
      ? getFieldValue(this.title.data, DIRECTOR_FIELD)
      : "";
  }
  get genre() {
    return this.title.data ? getFieldValue(this.title.data, GENRE_FIELD) : "";
  }
  get language() {
    return this.title.data
      ? getFieldValue(this.title.data, LANGUAGE_FIELD)
      : "";
  }
  get notableActors() {
    return this.title.data
      ? getFieldValue(this.title.data, NOTABLE_ACTORS_FIELD)
      : "";
  }
  get plotDescription() {
    return this.title.data
      ? getFieldValue(this.title.data, PLOT_DESCRIPTION_FIELD)
      : "";
  }
  get poster() {
    return this.title.data ? getFieldValue(this.title.data, POSTER_FIELD) : "";
  }
  get releaseDate() {
    return this.title.data
      ? getFieldValue(this.title.data, RELEASE_DATE_FIELD)
      : "";
  }
  get runtime() {
    return this.title.data ? getFieldValue(this.title.data, RUNTIME_FIELD) : "";
  }
  get writer() {
    return this.title.data ? getFieldValue(this.title.data, WRITER_FIELD) : "";
  }
  get availableStock() {
    if (this.title.data) {
